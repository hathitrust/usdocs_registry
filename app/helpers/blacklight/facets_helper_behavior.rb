module Blacklight::FacetsHelperBehavior
  ...
  def render_selected_facet_value(facet_field, item)
    content_tag(:span, :class => "facet-label") do
      # remove link
      link_to(image_tag('//catalog.hathitrust.org/images/silk/cancel.png', :alt=>"Delete "+facet_field+" facet", :class => "facetbutton"), search_action_path(remove_facet_params(facet_field, item, params)), :class=>"remove") +
