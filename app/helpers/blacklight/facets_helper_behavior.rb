module Blacklight::FacetsHelperBehavior
  ...
  def render_facet_value(facet_field, item, options ={})
    ...
    content_tag(:span, :class => "facet-label") do
      link_to_unless(options[:suppress_link], facet_display_value(facet_field, item), path, :class=>"facet_select", :rel=>"nofollow")
  ...
  def render_selected_facet_value(facet_field, item)
    content_tag(:span, :class => "facet-label") do
      # remove link
      link_to(image_tag('cancel.png', :alt=>"Remove facet: "+facet_field_label(facet_field)+' = '+facet_display_value(facet_field, item), :class => "facetbutton"), 
